...
<div class="satyadarshi-header">
    <div class="satyadarshi-brand">
        <div class="satyadarshi-wordmark">SatyadarshI<span> ◈</span>FASAL</div>
        <div class="satyadarshi-sub">Verify crop damage claims from space, in seconds.</div>
    </div>
    <div class="satyadarshi-right">
        <div class="satyadarshi-tag">NDVI PIPELINE v0.2</div>
